...
function AStep2() {
  return (
    <>
      ...
      <div style={{ display: "flex", gap: "20px", marginBottom: "12px" }}>
        <FF label="Expedición de la colegiación:" required style={{ flex: 1 }}><DateInput /></FF>
        <FF label="Expiración de la colegiación:" required style={{ flex: 1 }}><DateInput /></FF>
      </div>

      <div style={{ display: "flex", gap: "20px", marginBottom: "16px" }}>
        <FF label="Expedición de la licencia:" required style={{ flex: 1 }}><DateInput /></FF>
        <FF label="Expiración de la licencia:" required style={{ flex: 1 }}><DateInput /></FF>
      </div>

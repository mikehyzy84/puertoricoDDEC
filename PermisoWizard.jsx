...
// ═══════════════════════════════════════════
// PERMISO WIZARD - 8 Step Flow
// Exact match to DDEC screenshots pages 2-9
// ═══════════════════════════════════════════
...
// WIZARD BUTTONS
// ═══════════════════════════════════════════
function WizardButtons({ currentStep, onPrev, onNext, showPrev = true }) {
  return (
    ...
    <div style={{ padding: "20px 24px" }}>
      ...
      {owner === "otra" && (
        <div style={{ display: "flex", gap: "12px", alignItems: "flex-end" }}>
          ...
          <button style={{ backgroundColor: "#2b8a7a", color: "#fff", border: "none", borderRadius: "4px", width: "36px", height: "36px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
...
// SHARED COMPONENTS
// ═══════════════════════════════════════════
function FormField({ label, required, children, style: extraStyle }) {
  return (
...
export function PermisoWizard() {
  ...
  return (
    <div style={{ fontFamily: "Arial, Helvetica, sans-serif", backgroundColor: "#fff", minHeight: "100vh" }}>
      {/* Navbar would go here - same as main page */}
